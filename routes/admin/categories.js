...
exports.find = function(req, res, next){
  ...
  req.app.db.models.Category.pagedFind({
    ...
    if (req.xhr) {
      ...
      results.filters = req.query;
      res.render('../views/admin/categories/index', { data: { results: escape(JSON.stringify(results)) } });
    }
  });
};
...
exports.read = function(req, res, next){
  req.app.db.models.Category.findById(req.params.id).exec(function(err, category) {
    ...
    if (req.xhr) {
      ...
      res.render('../views/admin/categories/details', { data: { record: escape(JSON.stringify(category)) } });
    }
  });
};
